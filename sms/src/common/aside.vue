<template>
  <div>
    <el-menu
      ...
      <el-menu-item index="score" v-if="level !== 0" :class="{active: $route.name === '成绩查询'}">
        <i class="el-icon-s-unfold"></i>
        <span slot="title">&#12288{{courseTitle}}</span>
      </el-menu-item>

      <el-menu-item index="analysis" v-if="level === 2" :class="{active: $route.name === '成绩详情'}">
        <i class="el-icon-s-data"></i>
        <span slot="title">&#12288成绩详情</span>
      </el-menu-item>

      <el-menu-item index="course" v-if="level === 0" :class="{active: $route.name === '课程管理'}">
        <i class="el-icon-s-promotion"></i>
        <span slot="title">&#12288课程管理</span>
      </el-menu-item>
...
<script>
    export default {
        ...
        mounted() {
          ...
          this.courseTitle = this.level === 2 ? this.courseTitle:'成绩管理'
        }
    }
</script>
<style scoped>
